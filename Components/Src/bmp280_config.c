...
int8_t bmp280_spi_reg_write(uint8_t cs, uint8_t reg_addr, uint8_t *reg_data, uint16_t length)
{
  ...
  else if(cs == BMP280_CS2)
    HAL_GPIO_WritePin( BMP280_CS2_GPIO_Port, BMP280_CS2_Pin, GPIO_PIN_RESET );
  ...
  HAL_GPIO_WritePin( BMP280_CS2_GPIO_Port, BMP280_CS2_Pin, GPIO_PIN_SET );
